...
HD_PWD='C:/Users/Oliver Johnson/Documents/ANU/2021/engn3213/homeAutoCtrl/homeAutoCtrl/homeAutoCtrl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log homeAutoCtrl_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source homeAutoCtrl_top.tcl -notrace
